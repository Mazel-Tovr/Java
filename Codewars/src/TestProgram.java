...
public class TestProgram
{
    public static void main(String[] args) {
        ...
        */
        ...
        int g = 19090;
        System.out.println(Interval.sumIntervals(new int[][]{{235, 322}, {-2940, 9685}, {-4821, -1937}, {-5505, 6270}, {-1680, 645}, {-9405, -7523}, {-7633, 8713}, {3125, 6160}, {-8197, 335}, {-6173, -1032}, {-2759, 7882}}));
